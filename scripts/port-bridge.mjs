...
const AIR3_ALLOWED_ROUTES = [
  ...
  { method: 'GET', pattern: /^\/api\/airi3\/telegram\/link\/status$/ },
  { method: 'POST', pattern: /^\/api\/airi3\/telegram\/link\/preferences$/ },
  { method: 'POST', pattern: /^\/api\/airi3\/telegram\/link\/unlink$/ },
  { method: 'POST', pattern: /^\/api\/airi3\/telegram\/notify\/trade$/ },
