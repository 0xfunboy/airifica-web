...
const ttsCaptionPath = (import.meta.env.VITE_AIR3_TTS_CAPTION_PATH || '/api/tts/captioned').trim()
...
export const appConfig = {
  ...
  ttsCaptionPath,
  ttsCaptionUrl: resolveEndpointUrl(ttsRequestBaseUrl, ttsCaptionPath),
  ttsPhonemePath,
  ...
  ttsStreamEnabled: normalizeBoolean(import.meta.env.VITE_AIR3_TTS_STREAM_ENABLED, true),
  ttsStreamFormat: (import.meta.env.VITE_AIR3_TTS_STREAM_FORMAT || 'pcm').trim(),
  ttsStreamSampleRate: normalizeNumber(import.meta.env.VITE_AIR3_TTS_STREAM_SAMPLE_RATE, 24000),
  ttsStreamChunkMs: normalizeNumber(import.meta.env.VITE_AIR3_TTS_STREAM_CHUNK_MS, 180),
